        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
            ...
            <div className="flex flex-col text-brand-dark animate-fade-in-up text-center lg:text-left">
              <h2 className="text-xl lg:text-3xl font-display font-black mb-1 leading-tight uppercase tracking-tight">
                Lancez votre aventure <span className="text-white italic">iFret</span> dès maintenant !
              </h2>
              <p className="text-brand-dark/70 text-sm sm:text-base mb-4 max-w-lg font-bold mx-auto lg:ml-0">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 items-center">
                <a 
                  ...
                  className="flex items-center gap-2 bg-brand-dark px-4 py-1.5 rounded-lg shadow-lg hover:bg-black transition-all active:scale-95 border border-black/10"
                >
